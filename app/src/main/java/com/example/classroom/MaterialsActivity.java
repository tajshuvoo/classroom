...
public class MaterialsActivity extends AppCompatActivity implements MaterialsAdapter.OnItemClickListener{
    ...
    public void onItemClick(Materials material) {
        ...
        Intent intent = new Intent(MaterialsActivity.this, DetailedMaterial.class);
